    ...
    <div className="mx-auto max-w-6xl px-5 py-8 sm:px-8 sm:py-10">
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex items-center gap-4">
          <div className="flex h-12 w-[44px] flex-shrink-0 items-center justify-center rounded-t-[22px] rounded-b-md border-2 border-gold-soft bg-granate shadow-[0_6px_14px_-10px_rgba(74,15,24,0.45)]">
          ...
          <div>
            ...
            <h1 className="font-serif text-[1.7rem] font-semibold tracking-tight text-ink sm:text-[1.9rem]">
        ...
        <button
          ...
          className="flex-shrink-0 rounded-lg bg-granate px-4 py-2.5 text-[0.85rem] font-semibold text-sillar transition-[background-color,transform] duration-150 enabled:hover:bg-granate-deep enabled:active:scale-[0.98] focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold focus-visible:outline-offset-2"
        >
          + Nueva elección
        </button>
      </div>
